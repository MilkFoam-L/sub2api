...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	schedulingHandler := admin.NewSchedulingHandler(settingService)
	upstreamRateRepository := repository.NewUpstreamRateRepository(db)
	upstreamRateService := service.NewUpstreamRateService(upstreamRateRepository, secretEncryptor)
	upstreamRateHandler := admin.NewUpstreamRateHandler(upstreamRateService)
	...
	scheduledTestRunnerService := service.ProvideScheduledTestRunnerService(scheduledTestPlanRepository, scheduledTestService, accountTestService, rateLimitService, accountRepository, gatewayService, settingService, configConfig)
