...
type User struct {
	...
	// PrivacyFilterEnabled holds the value of the "privacy_filter_enabled" field.
	PrivacyFilterEnabled bool `json:"privacy_filter_enabled,omitempty"`
...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case user.FieldTotpEnabled, user.FieldBalanceNotifyEnabled, user.FieldPrivacyFilterEnabled:
...
func (_m *User) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case user.FieldPrivacyFilterEnabled:
			if value, ok := values[i].(*sql.NullBool); !ok {
				return fmt.Errorf("unexpected type %T for field privacy_filter_enabled", values[i])
			} else if value.Valid {
				_m.PrivacyFilterEnabled = value.Bool
			}
		default:
...
func (_m *User) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("privacy_filter_enabled=")
	builder.WriteString(fmt.Sprintf("%v", _m.PrivacyFilterEnabled))
	builder.WriteByte(')')
