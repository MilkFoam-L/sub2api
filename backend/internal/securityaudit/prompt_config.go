...
func PublicFromStorage(cfg storageConfig, riskControlEnabled bool) PublicConfig {
	...
	return PublicConfig{
		...
		StoreFullPrompt: cfg.StoreFullPrompt, EffectiveMode: active.EffectiveMode(), Strategy: cfg.Strategy, WorkerCount: cfg.WorkerCount,
...
func ActiveFromStorage(cfg storageConfig, riskControlEnabled bool, encryptor SecretEncryptor) (ActiveConfig, error) {
	active := ActiveConfig{
		...
		StorePassEvents: cfg.StorePassEvents, StoreFullPrompt: cfg.StoreFullPrompt,
