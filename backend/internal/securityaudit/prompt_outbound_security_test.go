...
func TestNormalizeBaseURLAllowsExplicitPrivateButBlocksSystemRanges(t *testing.T) {
	allowed := []string{
...
func TestHTTPClientUsesValidatedDirectDialer(t *testing.T) {
