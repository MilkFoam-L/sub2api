...
const (
	...
	// 会话安全设置
	SettingKeySessionBindingEnabled = "session_binding_enabled" // 会话 IP/UA 绑定（变更即失效），需显式开启

	// 敏感操作 step-up 2FA 设置
	SettingKeyStepUpEnabled = "step_up_enabled" // 敏感操作（导出/备份/S3配置/提升管理员等）要求 step-up 2FA，需显式开启
