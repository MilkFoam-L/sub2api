...
func (s *SettingService) InitializeDefaultSettings(ctx context.Context) error {
	...
	defaults := map[string]string{
		...
		SettingKeyOpenAIImagesResponsesReasoningEffort:               OpenAIImagesResponsesReasoningEffortDefault,
...
func (s *SettingService) parseSettings(settings map[string]string) *SystemSettings {
	...
	result.OpenAIImagesResponsesReasoningEffort = NormalizeOpenAIImagesResponsesReasoningEffort(settings[SettingKeyOpenAIImagesResponsesReasoningEffort])
