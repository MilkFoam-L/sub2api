...
defineProps(['selectedIds']); defineEmits(['delete', 'edit-selected', 'edit-filtered', 'delete-filtered', 'clear', 'select-page', 'toggle-schedulable', 'reset-status', 'refresh-token']); const { t } = useI18n()
</script>
