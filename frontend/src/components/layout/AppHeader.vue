    ...
    <div class="flex h-16 items-center justify-between px-4 md:px-6">
      ...
      <div class="flex items-center gap-3">
        ...
        <a
          ...
          class="flex items-center gap-1.5 rounded-md px-2.5 py-1.5 text-sm font-medium text-muted-foreground transition-colors hover:bg-accent hover:text-accent-foreground"
        >
        ...
        <div
          v-if="user"
          class="hidden items-center gap-2 rounded-md border border-border bg-muted px-3 py-1.5 sm:flex"
        >
          <svg
        ...
        <div v-if="user" class="relative" ref="dropdownRef">
          <button
            ...
            class="flex items-center gap-2 rounded-md p-1.5 transition-colors hover:bg-accent hover:text-accent-foreground"
            aria-label="User Menu"
          >
            <div class="flex h-8 w-8 items-center justify-center overflow-hidden rounded-md bg-primary text-sm font-medium text-primary-foreground shadow-sm">
              <img
                v-if="avatarUrl"
                :src="avatarUrl"
                :alt="displayName"
