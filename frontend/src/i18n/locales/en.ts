export default {
  ...
  profile: {
    ...
    privacyFilterTitle: 'Privacy Filter Protection',
    privacyFilterDescription: 'When enabled, model requests are redacted by the backend privacy-filter service before being forwarded upstream.',
    privacyFilterEnabled: 'Protection enabled',
    privacyFilterDisabled: 'Protection disabled',
    privacyFilterEnabledHint: 'Sensitive text such as emails and keys is redacted first.',
    privacyFilterDisabledHint: 'Requests continue through the gateway with their original content.',
    privacyFilterEnableSuccess: 'Privacy filter enabled',
    privacyFilterDisableSuccess: 'Privacy filter disabled',
    privacyFilterUpdateFailed: 'Failed to update privacy filter setting',
  ...
  admin: {
    ...
    accounts: {
      ...
      dataImportWarning: 'Import will create new accounts/proxies; you can select OpenAI groups before importing, and no default group is bound when none is selected. Ensure existing data does not conflict.',
      dataImportFile: 'Data file',
      dataImportGroups: 'Import account groups',
      dataImportGroupsHint: 'Only OpenAI groups are shown; successfully imported accounts will be bound to selected groups.',
      dataImportFileHint: 'Supports selecting multiple JSON files (.json)',
      ...
      bulkDeleteFilteredButton: 'Delete Filtered',
      bulkDeleteFilteredTitle: 'Delete Filtered Accounts',
      bulkDeleteFilteredConfirm: 'Delete {count} account(s) matching the current filters? This action cannot be undone.',
      ...
      recoverUpstreamBalance: 'Recover & Enable',
      recoverUpstreamBalanceSuccess: 'Account recovered and scheduling enabled',
      recoverUpstreamBalanceFailed: 'Failed to recover and enable account',
      ...
      openaiQuotaReset: {
        ...
        confirmTitle: 'Confirm OpenAI weekly limit reset',
    ...
    settings: {
      ...
      site: {
        ...
        siteSubtitlePlaceholder: 'Connect global AI models through one domain, one key, and governed access controls with observable, scalable, and manageable delivery.',
