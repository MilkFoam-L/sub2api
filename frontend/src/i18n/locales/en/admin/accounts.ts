export default {
    accounts: {
      ...
      dataImportFileHint: 'Select or drop one or more JSON export files.',
      dataImportGroups: 'Imported Account Groups',
      dataImportGroupsHint: 'Assign imported accounts to these groups; leave empty to keep them ungrouped.',
      ...
      recoverUpstreamBalance: 'Recover Upstream Balance Status',
      recoverUpstreamBalanceSuccess: 'Upstream balance status recovered',
      recoverUpstreamBalanceFailed: 'Failed to recover upstream balance status',
      ...
      status: {
        ...
        upstreamNoBalance: 'Insufficient Upstream Balance',
      ...
      upstreamBilling: {
        ...
        actualGroup: 'Actual group: {value}',
        observedGroups: 'Observed groups: {value}',
        newapiGroupUnresolved: 'This token has no usage log that can identify its group. Make one successful request, then try again.',
        newapiGroupAmbiguous: 'Recent logs contain multiple actual groups, so a single rate cannot be verified and no guess was made.',
        newapiGroupNotPriced: 'The actual group observed in token logs is absent from the current NewAPI pricing table.',
        newapiAPIUnsupported: 'The upstream supports neither the Sub2API billing protocol nor compatible NewAPI token-log and pricing endpoints.',
        stale: 'Stale',
      ...
      upstreamBalance: {
        ...
        manualProbe: 'Refresh upstream balance now',
        remaining: 'Remaining: {value} {currency}',
        unlimited: 'Unlimited',
        stale: 'Expired',
        unsupported: 'Unsupported',
        failed: 'Failed',
        ...
        updatedAt: 'Updated: {value}',
        nextProbeAt: 'Next refresh: {value}',
        lastDetectedBalance: 'Last detected balance: {value}',
        lastDetectedAt: 'Last detected: {value}',
        elapsedSince: 'Elapsed: {value}',
        justNow: 'less than 1 minute',
        minutesAgo: '{count} minutes',
        ...
        noEligibleAccounts: 'Select OpenAI API key accounts',
        batchLimit: 'A batch can probe at most 20 accounts',
        probeFailed: 'Failed to probe upstream balance',
        batchCompleted: 'Probed balance for {count} account(s)',
        batchPartial: 'Balance probe partially completed: {success} succeeded, {failed} failed'
      },
      ...
      bulkActions: {
        ...
        refreshToken: 'Refresh Token',
        probeUpstreamBalance: 'Probe Upstream Balance',
      ...
      bulkDeleteFilteredButton: 'Delete Filtered Accounts',
      bulkDeleteFilteredTitle: 'Delete Filtered Accounts',
      bulkDeleteFilteredConfirm: 'Delete the {count} account(s) matching the current filters? This action cannot be undone.',
      bulkDeleteFilteredEmpty: 'No accounts match the current filters.',
      ...
      enableOpenAITeam401Retryable: 'Enable 401team retryable',
      disableOpenAITeam401Retryable: 'Disable 401team retryable',
      openAITeam401RetryableEnabled: '401team retryable enabled',
      openAITeam401RetryableDisabled: '401team retryable disabled',
      openAITeam401RetryableFailed: 'Failed to update 401team retryable switch',
      ...
      modelProbe: {
        title: 'Model Probe',
        openButton: 'Probe Upstream Models',
        platform: 'Platform',
        baseUrl: 'Base URL',
        apiKey: 'API Key',
        secretHint: 'Credentials are used only for this probe and are not saved.',
        discover: 'Discover Models',
        discovering: 'Discovering...',
        loadCandidates: 'Load Candidate Models',
        loadingCandidates: 'Loading candidate models...',
        discoveredModels: 'Discovered Models ({count})',
        candidateModels: 'Candidate Models ({count})',
        noModels: 'No models found',
        discoverFailed: 'Failed to load model list',
        selectAll: 'Select All',
        clearSelected: 'Clear Selection',
        maxSelectionHint: 'Select up to {count} models per probe',
        mode: 'Probe Mode',
        modeResponses: 'Responses API',
        modeChatCompletions: 'Chat Completions API',
        modeGemini: 'Gemini generateContent',
        modeAnthropic: 'Anthropic Messages API',
        responsesHint: 'Send a minimal request through the OpenAI Responses API to verify each model.',
        chatCompletionsHint: 'Send a minimal request through the OpenAI Chat Completions API to verify each model.',
        geminiHint: 'Send a minimal request through Gemini generateContent to verify each model.',
        anthropicHint: 'Anthropic has no model-list endpoint, so built-in candidate models are loaded for testing.',
        testSelected: 'Test Selected Models',
        testing: 'Testing...',
        latestResults: 'Latest Results',
        ok: 'Available',
        failed: 'Failed',
        allFailed: 'All selected models failed',
        testFailed: 'Model probe failed',
        applyModels: 'Apply {count} Models',
      ...
      oauth: {
        ...
        openai: {
          ...
          mobileRefreshTokenAuth: 'OpenAI Mobile Refresh Token',
          accessTokenAuth: 'Manual Access Token Input',
