export default {
    ops: {
      ...
      runtime: {
        ...
        metricThresholdsHint: 'Set health thresholds for runtime metrics. Values outside these limits are highlighted in red on the dashboard.',
        slaMinPercent: 'Minimum SLA (%)',
        slaMinPercentHint: 'Highlighted in red when SLA falls below this value (default: 99.5%).',
        ttftP99MaxMs: 'Maximum TTFT P99 (ms)',
        ttftP99MaxMsHint: 'Highlighted in red when TTFT P99 exceeds this value (default: 500 ms).',
        requestErrorRateMaxPercent: 'Maximum Request Error Rate (%)',
        requestErrorRateMaxPercentHint: 'Highlighted in red when the request error rate exceeds this value (default: 5%).',
        upstreamErrorRateMaxPercent: 'Maximum Upstream Error Rate (%)',
        upstreamErrorRateMaxPercentHint: 'Highlighted in red when the upstream error rate exceeds this value (default: 5%).',
        silencing: {
