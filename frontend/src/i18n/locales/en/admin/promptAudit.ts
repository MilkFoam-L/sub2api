export default {
  promptAudit: {
    ...
    saveBar: { enabled: 'Enable prompt audit', blocking: 'Synchronous blocking', storePass: 'Store safe events', storeFull: 'Store full prompts (sensitive)', dirty: 'Unsaved changes', synced: 'Configuration synced' },
    blockingConfirm: {
