export default {
    ...
    usage: {
      ...
      tokenLeaderboardTitle: 'Token Leaderboard',
      tokenLeaderboardDescription: 'Rank users by token usage',
      tokenLeaderboardLimit: 'Rows',
      tokenLeaderboardTop: 'Top {count}',
      tokenLeaderboardLoadFailed: 'Failed to load token leaderboard',
      tokenLeaderboardNoData: 'No ranking data matches the current filters',
