    ...
    settings: {
      ...
      apiKeyAcl: {
        ...
        trustForwardedIpHint:
          'Disabled by default. When enabled, raw CF-Connecting-IP, X-Real-IP, or X-Forwarded-For values take over server.trusted_proxies for client-IP resolution. Leave it disabled to enforce the Gin trusted-proxy chain configured by server.trusted_proxies. Only enable takeover mode when the origin cannot be reached directly and the proxy overwrites these headers. Changing this switch changes existing session IP fingerprints.',
      ...
      upstreamBillingProbe: {
        ...
        description: 'Periodically retrieve upstream billing rates for OpenAI API keys. Supports the exact Sub2API protocol and NewAPI only when token logs uniquely verify the actual group.',
      ...
      gatewayForwarding: {
        ...
        openAIImagesResponsesReasoningEffort: 'OpenAI Image Response Reasoning Effort',
        openAIImagesResponsesReasoningEffortHint: 'Sets reasoning.effort when forwarding OpenAI image-generation requests through the Responses API.',
      ...
      customMenu: {
        ...
        openMode: 'Open Mode',
        openModeHint: 'Choose whether to embed the page, redirect in the current tab, or open it in a new tab.',
