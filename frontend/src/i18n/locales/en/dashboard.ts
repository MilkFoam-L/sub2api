export default {
  ...
  profile: {
    ...
    privacyFilterTitle: 'Privacy Protection Filter',
    privacyFilterDescription: 'Control whether requests use only accounts with privacy protection enabled.',
    privacyFilterEnabled: 'Privacy protection filter enabled',
    privacyFilterEnabledHint: 'Requests will only use accounts with privacy protection enabled.',
    privacyFilterDisabled: 'Privacy protection filter disabled',
    privacyFilterDisabledHint: 'Requests may use accounts without privacy protection enabled.',
    privacyFilterEnableSuccess: 'Privacy protection filter enabled',
    privacyFilterDisableSuccess: 'Privacy protection filter disabled',
    privacyFilterUpdateFailed: 'Failed to update privacy protection filter',
