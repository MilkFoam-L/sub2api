export default {
  ...
  profile: {
    ...
    privacyFilterTitle: '隐私过滤保护',
    privacyFilterDescription: '开启后，您的模型请求会先经后端隐私过滤服务脱敏敏感信息，再转发给模型。',
    privacyFilterEnabled: '已开启保护',
    privacyFilterDisabled: '未开启保护',
    privacyFilterEnabledHint: '请求中的邮箱、密钥等敏感文本会先被脱敏。',
    privacyFilterDisabledHint: '请求将按原始内容直接进入现有网关流程。',
    privacyFilterEnableSuccess: '隐私过滤已开启',
    privacyFilterDisableSuccess: '隐私过滤已关闭',
    privacyFilterUpdateFailed: '隐私过滤设置更新失败',
    changePassword: '修改密码',
  ...
  admin: {
    ...
    accounts: {
      ...
      dataImportWarning: '导入将创建新账号与代理；可在导入前选择 OpenAI 分组，未选择则不绑定默认分组。请确认已有数据不会冲突。',
      dataImportFile: '数据文件',
      dataImportGroups: '导入账号分组',
      dataImportGroupsHint: '仅显示 OpenAI 分组；导入成功的账号会自动绑定到选中分组。',
      ...
      bulkDeleteFilteredTitle: '删除当前筛选结果',
      ...
      recoverUpstreamBalance: '恢复并启用',
      recoverUpstreamBalanceSuccess: '账号已恢复并启用调度',
      recoverUpstreamBalanceFailed: '恢复并启用账号失败',
      fallbackActive: '已回退',
    ...
    settings: {
      ...
      site: {
        ...
        siteSubtitlePlaceholder: '通过统一域名与密钥接入全球大模型，并以风控策略沉淀可观测、可扩展、可治理的调用链路。',
        apiBaseUrl: 'API 端点地址',
