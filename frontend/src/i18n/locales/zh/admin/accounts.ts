export default {
    accounts: {
      ...
      dataImportFile: '数据文件',
      dataImportFileHint: '支持选择或拖入一个或多个 JSON 导出文件。',
      dataImportGroups: '导入账号分组',
      dataImportGroupsHint: '选择导入后的账号所属分组；留空则不分配分组。',
      ...
      testAccount: '测试账号',
      recoverUpstreamBalance: '恢复上游余额状态',
      recoverUpstreamBalanceSuccess: '上游余额状态已恢复',
      recoverUpstreamBalanceFailed: '恢复上游余额状态失败',
      searchAccounts: '搜索账号...',
      notes: '备注',
      ...
      upstreamBilling: {
        ...
        sourceNewAPI: '来源：NewAPI',
        actualGroup: '实际分组：{value}',
        observedGroups: '观察到的分组：{value}',
        newapiGroupUnresolved: '该 token 尚无可用于识别分组的消费日志；请先产生一次成功请求后重试。',
        newapiGroupAmbiguous: '近期日志出现多个实际分组，无法安全确定单一倍率，已拒绝猜测。',
        newapiGroupNotPriced: '日志中的实际分组未出现在 NewAPI 当前价格表中。',
        newapiAPIUnsupported: '上游既不支持 Sub2API 倍率协议，也未提供可兼容的 NewAPI 日志/价格接口。',
        stale: '已过期',
        unsupported: '不支持',
        failed: '失败',
        notProbed: '未探测',
      ...
      upstreamBalance: {
        ...
        manualProbe: '立即刷新上游余额',
        remaining: '剩余：{value} {currency}',
        unlimited: '无限额度',
        stale: '已过期',
        unsupported: '不支持',
        failed: '失败',
        ...
        updatedAt: '更新时间：{value}',
        nextProbeAt: '下一次刷新：{value}',
        lastDetectedBalance: '上次探测余额：{value}',
        lastDetectedAt: '上次探测时间：{value}',
        elapsedSince: '已过去：{value}',
        justNow: '不足 1 分钟',
        minutesAgo: '{count} 分钟',
        ...
        noEligibleAccounts: '请选择 OpenAI API Key 账号',
        batchLimit: '每次最多探测 20 个账号',
        probeFailed: '探测上游余额失败',
        batchCompleted: '已完成 {count} 个账号的余额探测',
        batchPartial: '余额探测部分完成：成功 {success} 个，失败 {failed} 个'
      },
      ...
      bulkDeleteFilteredButton: '删除筛选结果',
      bulkDeleteFilteredTitle: '删除筛选出的账号',
      bulkDeleteFilteredConfirm: '确定要删除当前筛选条件命中的 {count} 个账号吗？此操作无法撤销。',
      bulkDeleteFilteredEmpty: '当前筛选条件下没有可删除的账号',
      ...
      enableOpenAITeam401Retryable: '开启 401team 可重试',
      disableOpenAITeam401Retryable: '关闭 401team 可重试',
      openAITeam401RetryableEnabled: '已开启 401team 可重试',
      openAITeam401RetryableDisabled: '已关闭 401team 可重试',
      openAITeam401RetryableFailed: '更新 401team 可重试开关失败',
      ...
      modelProbe: {
        ...
        baseUrl: 'Base URL',
        apiKey: 'API Key',
        secretHint: '凭证仅用于本次探测，不会保存。',
        discover: '发现模型',
        discovering: '正在发现...',
        loadCandidates: '加载候选模型',
        loadingCandidates: '正在加载候选模型...',
        discoveredModels: '已发现模型（{count}）',
        candidateModels: '候选模型（{count}）',
        noModels: '未发现可用模型',
        discoverFailed: '获取模型列表失败',
        selectAll: '全选',
        clearSelected: '清除选择',
        maxSelectionHint: '一次最多选择 {count} 个模型进行探测',
        mode: '探测模式',
        ...
        responsesHint: '通过 OpenAI Responses API 发送最小请求以验证模型。',
        chatCompletionsHint: '通过 OpenAI Chat Completions API 发送最小请求以验证模型。',
        geminiHint: '通过 Gemini generateContent 接口发送最小请求以验证模型。',
        anthropicHint: 'Anthropic 不提供模型列表接口，将加载内置候选模型供测试。',
        testSelected: '测试所选模型',
        testing: '测试中...',
        latestResults: '最近测试结果',
        ok: '可用',
        failed: '失败',
        allFailed: '所选模型均测试失败',
        testFailed: '模型测试失败',
        applyModels: '应用 {count} 个模型',
