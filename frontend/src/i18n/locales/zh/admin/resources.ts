export default {
    ...
    usage: {
      ...
      tokenLeaderboardTitle: 'Token 排行榜',
      tokenLeaderboardDescription: '按 Token 用量查看用户排名',
      tokenLeaderboardLimit: '展示数量',
      tokenLeaderboardTop: '前 {count} 名',
      tokenLeaderboardLoadFailed: '加载 Token 排行榜失败',
      tokenLeaderboardNoData: '当前筛选条件下暂无排行数据',
      tokenLeaderboardRank: '排名',
      tokenLeaderboardUser: '用户',
      tokenLeaderboardTokens: 'Token',
      tokenLeaderboardRequests: '请求数',
