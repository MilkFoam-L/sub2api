export default {
  ...
  profile: {
    ...
    privacyFilterTitle: '隐私保护筛选',
    privacyFilterDescription: '控制请求是否仅使用已启用隐私保护的账号。',
    privacyFilterEnabled: '已启用隐私保护筛选',
    privacyFilterEnabledHint: '请求仅会使用已启用隐私保护的账号。',
    privacyFilterDisabled: '未启用隐私保护筛选',
    privacyFilterDisabledHint: '请求可以使用未启用隐私保护的账号。',
    privacyFilterEnableSuccess: '隐私保护筛选已启用',
    privacyFilterDisableSuccess: '隐私保护筛选已禁用',
    privacyFilterUpdateFailed: '更新隐私保护筛选失败',
    administrator: '管理员',
    user: '用户',
    username: '用户名',
    email: '邮箱',
